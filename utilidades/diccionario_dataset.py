...
print(info_features("mun_regist"))
print(info_features("loc_regis"))
print(info_features("tloc_regis"))
print(info_features("ent_mat"))
print(info_features("mun_mat"))
print(info_features("local_mat"))
print(info_features("tloc_mat"))
print(info_features("dia_mat"))
print(info_features("mes_mat"))
print(info_features("anio_mat"))
print(info_features("dia_reg"))
print(info_features("mes_reg"))
print(info_features("anio_reg"))
print(info_features("dia_sen"))
print(info_features("mes_sen"))
print(info_features("dia-eje"))
print(info_features("mes-eje"))
print(info_features("anio-eje"))
print(info_features("ini_juic"))
print(info_features("favor"))
print(info_features("caus"))
print(info_features("hijos"))